...
export const Activity = () => {
  return (
    <div className="flex flex-col items-center justify-end w-full py-14 mx-auto rounded-3xl drop-shadow-lg bg-white">
      <div className="self-stretch px-7 justify-center items-center gap-2.5 inline-flex">
        <div className="text-primary text-3xl font-bold font-['YuGothic'] tracking-wider">
          勉強会・LT会
        </div>
      </div>
